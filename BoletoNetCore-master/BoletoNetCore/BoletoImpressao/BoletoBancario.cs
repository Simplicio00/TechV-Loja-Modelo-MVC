...
//
        ...
        public byte[] MontaPDFAlternativo(bool convertLinhaDigitavelToImage = false)
		{
            return new HtmlToPdf().RenderHtmlAsPdf(MontaHtmlEmbedded(convertLinhaDigitavelToImage, true)).BinaryData;
        }
